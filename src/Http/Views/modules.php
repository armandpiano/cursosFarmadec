...
<div class="container">
    <div class="row mb-4">
        <div class="col">
            ...
            <h1 class="display-5 fw-bold"><?php echo htmlspecialchars($courseData['title']); ?></h1>
            <p class="lead text-muted"><?php echo htmlspecialchars($courseData['description']); ?></p>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="card-title mb-0">
                            <i class="bi bi-graph-up"></i> Progreso del Curso
                        </h5>
                        <span class="badge bg-primary fs-6"><?php echo $courseData['progress_percent']; ?>% completado</span>
                    </div>
                    <div class="progress mb-3" style="height: 30px;">
                        <div class="progress-bar progress-bar-striped progress-bar-animated" 
                            ...
                            <?php if ($courseData['progress_percent'] > 10): ?>
                                <?php echo $courseData['progress_percent']; ?>%
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php if ($courseData['status'] === 'completed'): ?>
                    <div class="alert alert-success d-flex align-items-center">
                        <i class="bi bi-check-circle-fill me-2"></i>
                        <div>
                            <strong>¡Curso Completado!</strong> 
                            <span class="ms-2">Has completado exitosamente este curso.</span>
                        </div>
                    </div>
                    <a href="<?php echo url('certificate/' . $courseData['id']); ?>" 
