                    ...
                    <div class="capsule-page mb-4" data-page="<?php echo $index; ?>" 
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="capsule-content mb-4">
...
function showExam(exam) {
    ...
    exam.questions.forEach(function(q, index) {
        ...
        q.options.forEach(function(opt) {
            ...
            html += '<input class="form-check-input" type="' + inputType + '" name="q' + q.id + '[]" value="' + opt.id + '" id="opt' + opt.id + '">';
...
function submitExam(examId, formData) {
    ...
    for (let [key, value] of formData.entries()) {
        const questionId = key.replace('q', '').replace('[]', '');
...
function showExamResult(result) {
    ...
    html += '<p>Puntaje mínimo requerido: ' + result.pass_score + '%</p>';
    ...
    if (result.passed) {
        ...
        html += '<button class="btn btn-outline-primary btn-lg" onclick="location.reload()">Reintentar Examen</button>';
    }
